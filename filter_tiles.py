...
def singleprocess_apply_filters_to_images(folder, save=False, display=False, html=False, image_num_list=None):
  """
...
def multiprocess_apply_filters_to_images(folder, save=False, display=False, html=False, image_num_list=None):
  ...
  """
  timer = Time()
  print("Applying filters to Tiles(multiprocess)\n")

  tile_dir = cg.TILE_DIR + str(folder) + "\\"
  # print("split_tiles_dir = ", split_tiles_dir,  "\n")

  save_dir = cg.TISSUE_PERCENT_DIR + str(folder) + "_filtered" + "\\"

  # print("save_dir = ", save_dir, "\n")

  image_list = os.listdir(tile_dir)  
...
# if __name__ == "__main__":
	...
	# tissue_percent_dict = singleprocess_filter_patches("001")

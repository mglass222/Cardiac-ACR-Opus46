...
def apply_image_filters(np_img, slide_num=None, info=None, save=False, display=False):
  ...
  # save_display(save, display, info, rgb_no_black_pen, slide_num, 4, "No Black Pen", "rgb-no-black-pen")
  ...
  # save_display(save, display, info, rgb_gray_green_pens, slide_num, 5, "Not Gray, Not Green, No Pens", "rgb-no-gray-no-green-no-pens")

...
# If False, suppress filter-module prints (np_info, overmask retries,
# per-slide/per-task progress, save-image timings). Flip to True to
# restore the original chatty filter output for debugging.
VERBOSE = False

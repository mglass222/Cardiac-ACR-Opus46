...
def annotate_slide(slide_number, saved_database_dir, test_slide_annotations_dir):

    utils.make_directory(test_slide_annotations_dir)

    xmlfilename = os.path.join(test_slide_annotations_dir, str(slide_number) + ".xml")
    ...
    all_dicts = load_diagnoses(slide_number, saved_database_dir)
...
def load_diagnoses(slide_number, saved_database_dir):
...
def main(slide_number, saved_database_dir, test_slide_annotations_dir):

    annotate_slide(slide_number, saved_database_dir, test_slide_annotations_dir)

...
def initialize_dataloaders(
    ...
    image_datasets = {
        # allow_empty=True tolerates classes that land entirely in the
        # Training split (e.g. Hemorrhage with the paper's TRAIN_SLIDES
        # list). Both splits still see the same sorted class list, so
        # ImageFolder indexes stay aligned between Training and Validation.
        phase: datasets.ImageFolder(
            os.path.join(training_root, phase),
